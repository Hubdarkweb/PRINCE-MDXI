...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "PRINCE-MDX~LdAqjIk0YysTTPUnwkym", // Add sess Id here espwcially when deploying on panels else use app.json and .env file...
SUDO_NUMBERS: process.env.SUDO_NUMBERS || "254112386921", //Add multiple Numbers with Country Codes without (+) Separated by Comma...
...
OWNER_NUMBER: process.env.OWNER_NUMBER || "254112386921", // Only 1 owner Number Here, others Add to sudo numbers...
